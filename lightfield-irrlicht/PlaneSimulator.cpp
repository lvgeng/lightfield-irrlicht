...
PlaneSimulator::PlaneSimulator(vector3df cameraPositionInput, int widthOfDisplayzoneByPixel, int heightOfDisplayzoneByPixel, int widthOfSubimageByPixel, int heightOfSubimageByPixel, double widthOfSubimageBymm, double heightOfSubimageBymm, double thicknessOfTransparentMaterialBetweenDevices, double refractionIndexOfTransparentMaterial, int widthOfHoleByPixel, int HeightOfHoleByPixle)
{
	cameraPosition = cameraPositionInput;
	widDisplayzoneByPixel = widthOfDisplayzoneByPixel;
	heiDisplayzoneByPixel = heightOfDisplayzoneByPixel;
